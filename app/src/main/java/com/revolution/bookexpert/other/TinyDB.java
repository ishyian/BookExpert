...
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        preferences = appContext.getSharedPreferences("bookexxpert", Context.MODE_PRIVATE);
    }
    ...
    public ArrayList<Book> getListHistory(String key) {
        Gson gson = new Gson();
    ...
    public void putHistoryList(String key, ArrayList<Book> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
