package com.revolution.bookexpert;
...
/*public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getVoiceMessage() {
        Message message = new Message(getRandomId(), getUser(), null);
        message.setVoice(new Message.Voice("https://file-examples-com.github.io/uploads/2017/11/file_example_MP3_1MG.mp3", rnd.nextInt(200) + 30));
        return message;
    }
